...
class BlogComponent extends Component {
    ...
    getData(length = false, isSearch = false) {
        let url = `https://newsapi.org/v2/top-headlines?country=id&sortBy=popularity&apiKey=d50d38a9e166421abc022d847ace3358`

        if (isSearch) {
            url = `https://newsapi.org/v2/top-headlines?country=id&sortBy=popularity&apiKey=d50d38a9e166421abc022d847ace3358&q=${isSearch}`
        }
        if (length) {
            url = `https://newsapi.org/v2/top-headlines?country=id&sortBy=popularity&apiKey=d50d38a9e166421abc022d847ace3358&pageSize=${length}`
        }
